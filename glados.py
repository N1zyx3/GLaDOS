...
IPA_TO_RU = {
    'ˈ': '+', 'ˌ': '', 'ɑ': 'а', 'æ': 'э', 'ʌ': 'а', 'ɔ': 'о', 'ɒ': 'о', 'ɛ': 'э',
    'ɜ': 'ё', 'ɪ': 'и', 'i': 'и', 'ʊ': 'у', 'u': 'у', 'eɪ': 'эй', 'aɪ': 'ай',
    'ɔɪ': 'ой', 'oʊ': 'оу', 'əʊ': 'оу', 'aʊ': 'ау', 'ɪə': 'иэ', 'eə': 'эа',
    'ʊə': 'уэ', 'p': 'п', 'b': 'б', 't': 'т', 'd': 'д', 'k': 'к', 'g': 'г',
    'f': 'ф', 'v': 'в', 'θ': 'с', 'ð': 'з', 's': 'с', 'z': 'з', 'ʃ': 'ш',
    'ʒ': 'ж', 'h': 'х', 'm': 'м', 'n': 'н', 'ŋ': 'нг', 'l': 'л', 'r': 'р',
    'ɹ': 'р', 'j': 'й', 'w': 'у', 'tʃ': 'ч', 'dʒ': 'дж', 'ə': 'а', 'ɚ': 'эр',
    'ɝ': 'эр'
}
